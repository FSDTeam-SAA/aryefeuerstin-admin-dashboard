        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t">
            <p className="text-sm text-gray-600">
              Showing {filteredItems.length === 0 ? 0 : (currentPage - 1) * RESULTS_PER_PAGE + 1} to{" "}
              {Math.min(currentPage * RESULTS_PER_PAGE, data?.data.pagination.total || 0)} of {data?.data.pagination.total || 0} results
            </p>
