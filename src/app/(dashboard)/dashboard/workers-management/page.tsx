...
// // import AddWorkerModal from "./_components/add-worker-modal"
...
// //   name: string;
// //   email: string;
// //   role: string; // could also be a union type like "ADMIN" | "SUPER_ADMIN" etc.
// //   permissions: string[];
...
// //     const { data } = useQuery<AdminListResponse>({
// //         queryKey: ["worker"],
// //         queryFn: async () => {
...
// //                                     Status
// //                                 </TableHead>
// //                                 <TableHead className="text-[10px] uppercase text-gray-400 text-right">
// //                                     Action
// //                                 </TableHead>
// //                             </TableRow>
// //                         </TableHeader>
...
// //                         <TableBody>
// //                             {STATIC_WORKERS.map((member, index) => (
...
//                                         <TableCell className="py-6 font-medium">{member._id}</TableCell>
//                                         <TableCell className="py-6">{member.name}</TableCell>
//                                         <TableCell className="py-6">{member.email}</TableCell>
//                                         <TableCell className="py-6">
...
//                                 variant="ghost"
//                                 size="icon"
//                                 className={p === data?.data?.pagination.currentPage ? "bg-gray-200" : ""}
//                             >
//                                 {p}
//                             </Button>
//                         ))}
